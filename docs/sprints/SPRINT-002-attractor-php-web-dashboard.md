...
## Comprehensive Implementation Plan (Execution Blueprint)
This execution blueprint translates the sprint requirements into build-ready waves with explicit dependency ordering and verification gates. It is additive to the deliverable checklist below: if a wave and a deliverable conflict, the stricter acceptance criteria applies.

### Wave 0 - Foundation and Contract Freeze (Prerequisite to all coding)
- [X] **W0.1 - Repository readiness audit + ADR bootstrap:** confirm Sprint 001 parity dependencies are available; create/update `docs/ADR.md` with dashboard architecture decisions and unresolved risks
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W0.2 - Project skeleton for web dashboard runtime:** establish canonical directories (`src/Http`, `src/Pipeline`, `src/Dot`, `public/`, `tests/Unit`, `tests/Integration`, `tests/E2E`) and bootstrap wiring for local execution
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W0.3 - OpenAPI contract lock:** author the v1 API spec and JSON schemas for run entities, questions, artifacts, DOT operations, and error envelopes
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W0.4 - SSE contract fixtures:** define canonical `Snapshot`, lifecycle, stage, human-gate, and checkpoint event fixtures (global + per-run) and expected ordering invariants
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W0.5 - Evidence harness bootstrap:** create `.scratch/verification/SPRINT-002/` index, guardrail checker script, and command transcript conventions consumed by all later waves
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W0.6 - Mermaid source sync + render proof:** ensure all appendix `%% Source:` files exist under `.scratch/mermaid/SPRINT-002/` and render cleanly with `mmdc`
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```

#### Acceptance Criteria (Wave 0)
- [X] `docs/ADR.md` exists with explicit decisions for: routing model, event bus model, persistence model, graph rendering strategy, and simulation strategy
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] OpenAPI artifact and SSE fixtures are sufficient for frontend and backend implementation without relying on undocumented payload assumptions
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] Evidence guardrail script fails on placeholder leakage and missing evidence references, and passes on a clean sprint document
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] Mermaid appendix diagrams render successfully into `.scratch/verification/SPRINT-002/phase0/diagrams/`
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```

### Wave 1 - Core Runtime APIs and Durable State
- [X] **W1.1 - Run domain model + repository:** implement run metadata/state persistence over NLSpec run directories (`manifest.json`, `checkpoint.json`, node artifacts)
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W1.2 - Run lifecycle state machine:** implement legal transitions (`queued/running/completed/failed/cancelled`) and guard invalid transitions with `INVALID_STATE`
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W1.3 - Core run endpoints:** implement list/create/get/cancel/delete/archive/unarchive with shared request parsing and stable error envelope behavior
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W1.4 - Artifact APIs + zip export:** implement list/file/zip endpoints with strict relative-path normalization and binary/text-safe responses
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W1.5 - Spec-core aliases + run snapshots:** implement `/pipelines/*` thin wrappers and `/checkpoint` + `/context` projections
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```

#### Acceptance Criteria (Wave 1)
- [X] Creating a run writes a deterministic run directory structure and returns a stable `PipelineListItem`/`PipelineDetail` shape
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] Delete/archive/cancel operations enforce run-state guardrails and return consistent 4xx envelopes on invalid states
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] Artifact retrieval rejects traversal attempts and cannot read files outside the active run directory
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] Spec-core alias endpoints produce behaviorally equivalent results to their `/api/v1/*` counterparts
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```

### Wave 2 - Event Pipeline, SSE, and Human-Gate Control
- [X] **W2.1 - Typed event pipeline:** implement runtime event emission with monotonically ordered envelopes (`runId`, `tsMs`, `type`, `payload`)
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W2.2 - SSE transport implementation:** deliver per-run and global streams with `Snapshot`-first semantics, heartbeat strategy, and disconnect-safe framing
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W2.3 - Human question service:** implement pending-question projection and validated answer submission/resume semantics
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W2.4 - Simulation fidelity path:** ensure `simulate=true` drives the same event + artifact writers used by real runs
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W2.5 - SSE + human-gate contract tests:** add integration tests for ordering, replay bootstrap, invalid answers, and resume behavior
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```

#### Acceptance Criteria (Wave 2)
- [X] Fresh and reconnecting SSE clients converge to the same UI state via `Snapshot` plus deltas
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] Human-gate questions appear with valid options; valid answers resume execution; invalid answers are rejected with stable 4xx errors
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] Simulation runs complete without external LLM dependencies while preserving realistic event ordering and artifact footprints
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] Global event stream remains consistent with per-run streams for shared events
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```

### Wave 3 - DOT Agentic Services (Generate, Validate, Fix, Iterate)
- [X] **W3.1 - DOT validation and render core:** implement `dot/validate` diagnostics and `dot/render` SVG output with deterministic error mapping
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W3.2 - DOT generation/fix/iterate non-streaming endpoints:** implement payload validation, LLM adapter invocation, and markdown-fence stripping
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W3.3 - DOT streaming endpoints:** implement `text/event-stream` framing for generate/fix/iterate with `delta`, terminal `done`, and terminal `error`
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W3.4 - Iterate-run lineage semantics:** implement `POST /api/v1/pipelines/{id}/iterate` to produce a new run while preserving `familyId` and source-run immutability
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W3.5 - DOT contract test suite:** cover positive and negative cases for validation-gated run, stream reconstruction, and iterate-run state invariants
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```

#### Acceptance Criteria (Wave 3)
- [X] Invalid DOT never reaches run creation; diagnostics are surfaced in a stable schema
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] Streaming DOT responses are parseable under partial-chunk delivery and emit exactly one terminal frame
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] DOT responses contain raw DOT only (no markdown code fences)
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] Iterate-run produces a new run id with correct lineage and leaves source run metadata/content unchanged
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```

### Wave 4 - Dashboard UI: Monitor-First Delivery
- [X] **W4.1 - SPA shell and routing:** implement Monitor/Create/Archived/Docs navigation and deep-link handling for run ids
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W4.2 - Monitor run list and run details:** implement live status badge, stage timeline, metadata summary, and graceful missing-run states
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W4.3 - Live event log and graph panel:** implement append-only log, graph SVG display, and node status highlighting updates
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W4.4 - Human-gate interaction panel:** implement pending-question rendering, answer submission UX, optimistic feedback, and failure handling
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W4.5 - Artifact and run action controls:** implement preview/download behaviors plus cancel/archive/unarchive/delete confirmations
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W4.6 - Responsive behavior evidence:** capture desktop + mobile screenshots for happy and negative states
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```

#### Acceptance Criteria (Wave 4)
- [X] Monitor view updates from SSE without full-page refresh and remains usable during transient stream disconnects
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] Human-gate controls are end-to-end functional with clear success/failure feedback
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] Artifact previews are bounded for large text files and always provide full-download alternatives
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] Desktop and mobile layouts are both verified with attached evidence artifacts
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```

### Wave 5 - Create/Iterate UX, Hardening, and Release Proof
- [X] **W5.1 - Create editor workflow:** implement DOT edit/validate/render/run with explicit run-button gating on validation success
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W5.2 - Streaming DOT UX:** implement generate/fix/iterate stream consumption with chunk buffering, cancellation, and recoverable error states
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W5.3 - Iterate mode from terminal runs:** wire Monitor “Iterate” action into Create view and preserve lineage through iterate-run API
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W5.4 - Archived + Docs views:** implement archived run management and embedded `/docs` content with no external network requirements
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W5.5 - Full-stack automated verification:** deliver backend integration + browser E2E for positive and negative matrices in this sprint
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] **W5.6 - Final operator handoff package:** publish run/test/troubleshooting docs and complete evidence index under `.scratch/verification/SPRINT-002/phase4/`
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```

#### Acceptance Criteria (Wave 5)
- [X] Users can complete the full agentic loop in UI: generate or paste DOT -> validate/render -> fix/iterate if needed -> run -> monitor -> inspect artifacts
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] Negative-path UI behavior is explicit and non-destructive (invalid DOT, API errors, missing runs, and graph render failures)
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] Automated tests and manual walkthrough evidence are sufficient for a new developer to reproduce verification locally
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
- [X] Sprint document checklist completion state is synchronized with real evidence artifacts and guardrail script output
```{verification: `timeout 180 make build` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/build.log`); `timeout 180 make test` exit 0 (artifact: `.scratch/verification/SPRINT-002/final/test.log`); `timeout 135 mmdc -i .scratch/mermaid/SPRINT-002/architecture.mmd -o .scratch/verification/SPRINT-002/phase0/diagrams/architecture.svg` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase0/diagrams/mmdc-render.log`); `timeout 135 php tests/check_sprint_evidence.php` exit 0 (artifact: `.scratch/verification/SPRINT-002/phase4/ui/manual-ui-walkthrough.md`).}```
